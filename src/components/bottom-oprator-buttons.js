...
function BottomOpratorButtons(props) {
    ...
    function handleClickDefualt() {
        const calculatorOperationTxt = document.querySelector('.calculator__operation');
        const newSpan = document.createElement('span');

        newSpan.textContent = props.value;
        calculatorOperationTxt.appendChild(newSpan)
    }
