...
function BottomOpratorButtons(props) {
    ...
    if (props.value === 'delete') {
        ...
        return <button onClick={handleSin} data-value={props.value} className={'calculator__oprator-btn'}>{props.value}</button>
    } else if (props.value === 'deg') {
        return <button onClick={handleDeg} data-value={props.value} className={'calculator__oprator-btn'}>{props.value}</button>
    } else {
